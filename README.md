...
### [`.aliases`](https://github.com/amalgamet/dotfiles/blob/master/.aliases) and [`.functions`](https://github.com/amalgamet/dotfiles/blob/master/.functions)
